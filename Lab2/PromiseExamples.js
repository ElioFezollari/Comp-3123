...
Promise.all(makePromise(10),makePromise(20),makePromise(30),console.log(res)).catch((error)=>{console.error(error)}).finally(()=>{console.log("Finally Block")})